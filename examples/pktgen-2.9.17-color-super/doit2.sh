...
#Four port
#./app/app/x86_64-native-linuxapp-gcc/pktgen -c 0x1f -n 3 -- -P -m "1.0,2.1,3.2,4.3"
...
#./app/app/x86_64-native-linuxapp-gcc/pktgen -c 0x1f -n 1 --proc-type auto --socket-mem 2048 --file-prefix pg -- -p 0x3 -P -m "[1:3].0, [2:4].1"  -f test/set_seq_wxb.pkt
 ...
 ./app/app/x86_64-native-linuxapp-gcc/pktgen -c 0x3E0000 -n 3  --proc-type auto \
 --socket-mem 1024,1024 --file-prefix pg4 \
 -w 83:00.0 -w 83:00.1 -w 83:00.2 -w 83:00.3\
 -- \
 -T -P -m "18.0, 19.1, 20.2, 21.3" \
