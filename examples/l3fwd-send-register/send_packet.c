...
pktgen_ctor_register(struct rte_mbuf *m)
{
	...
	switch(mysrand(1,1))
	{
		case 1: printf("Receving REGISTER ACK--STATE=[\033[1;31;46m SUCCESS \033[0m ]\n SID="); break;
		case 2: printf("Receving REGISTER ACK--STATE=[\033[1;32;42m DUPLICATE \033[0m]\n SID="); break;
		case 3: printf("Receving REGISTER ACK--STATE=[\033[1;33;41m INVALID \033[0m]\n SID="); break;
		case 4: printf("No Receiving REGISTER ACK--STATE=[\033[1;34;47m TIMEOUT \033[0m]\n SID="); break;
	}
...
pktgen_ctor_GET(struct rte_mbuf *m)
{
	...
	CoLoR_get_t * get_hdr=rte_pktmbuf_mtod_offset(m,CoLoR_get_t *,sizeof(struct ether_hdr)+sizeof(struct ipv4_hdr));
